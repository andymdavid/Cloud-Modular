...
export default function HomeV2() {
  ...
  const btnPrimary = isLight ? "bg-[#080a0a] text-white hover:bg-[#1a1c1d]" : "bg-white text-forest hover:bg-[#d9d4ce]";
        ...
        <div
          className={cn(
            ...
            isLight
              ...
              : "bg-[linear-gradient(180deg,rgba(8,10,10,0.42)_0%,rgba(8,10,10,0.34)_14%,rgba(8,10,10,0.28)_32%,rgba(8,10,10,0.24)_50%,rgba(8,10,10,0.42)_74%,rgba(8,10,10,0.72)_100%)]"
          )}
          aria-hidden
        />
        <div
